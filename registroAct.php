            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    ...
                    echo '
                        ...
                        <li class="active"><a href="#"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">RegistroAct</span></a></li>
                            ...
                            <div class="col-md-11">
                                <div class="panel panel-primary">
                                    <div class="panel-heading" style="display: flex; align-items: center; flex-wrap: wrap;">
                                        <h2 class="text-center" style="flex-basis: 100%;">Registro de Actividades</h2>
                                        <div style="width: 100%;">
                                        <?php 
                                        echo "
                                            <button class='btn btn-success' type='button' onclick='window.location.href = `registroActAdd.php?user=$user`' style='margin-bottom: 10px';>Agregar</button>";
                                        ?>
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        ...
                                        <tbody>
                                            <?php
                                                include('conecta.php');
                                                $query = "SELECT `r`.`idRegistroAct`, `c`.`nombre`, `r`.`idConexion`, `r`.`FechaYhora`, `r`.`descAct` FROM `registroact` `r` INNER JOIN `cliente` `c` ON `r`.`idClinete` = `c`.`idCliente` WHERE `r`.`estatus` = 1";
                                                ...
                                                while($row = mysqli_fetch_assoc($result)){
                                                    ...
                                                    <tr class='larger-row'>
                                                        ...
                                                        <td>".$row['descAct']."</td>
                                                        <td>
                                                            <form action='registroActEditar.php' method='post'>
                                                                <input type='hidden' name='editar' id='editar' value='".$row['idRegistroAct']."'>
                                                        ...
                                                        <td>
                                                            <form action='registroActEliminar.php' method='post'>
                                                                <input type='hidden' name='borrar' value='".$row['idRegistroAct']."'>
                                                                <input type='hidden' name='user' id='user' value='".$user."'>
