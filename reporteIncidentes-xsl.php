...
$xml = new XMLWriter();
$xml->openURI('ReporteIncidentes.xml');
...
header('Content-Disposition: attachment; filename="ReporteIncidentes.xml"');
readfile('ReporteIncidentes.xml');
?>