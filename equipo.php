            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    ...
                    echo '
                        ...
                        <li class="active"><a href="#"><i class="fa fa-calendar" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Equipo</span></a></li>
                            ...
                            <div class="col-md-11">
                                <div class="panel panel-primary">
                                    <div class="panel-heading" style="display: flex; align-items: center; flex-wrap: wrap;">
                                        <h2 class="text-center" style="flex-basis: 100%;">Equipo</h2>
                                        <div style="width: 100%;">
                                        <?php 
                                        echo "
                                            <button class='btn btn-success' type='button' onclick='window.location.href = `equipoAdd.php?user=$user`' style='margin-bottom: 10px';>Agregar</button>";
                                        ?>
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        ...
                                        <tbody>
                                            <?php
                                                include('conecta.php');
                                                $query = "SELECT `e`.`idEquipo`, `u`.`nombre`, `e`.`equipo`, `e`.`SistemaOperativo`, `e`.`DireccionIP` FROM `equipo` `e` INNER JOIN `usuario` `u` ON `e`.`idUsuario` = `u`.`idUsuario` WHERE `e`.`estatus` = 1";
                                                ...
                                                while($row = mysqli_fetch_assoc($result)){
                                                    ...
                                                    <tr class='larger-row'>
                                                        ...
                                                        <td>
                                                            <form action='equipoEditar.php' method='post'>
                                                                <input type='hidden' name='editar' id='editar' value='".$row['idEquipo']."'>
                                                        ...
                                                        <td>
                                                            <form action='equipoEliminar.php' method='post'>
                                                                <input type='hidden' name='borrar' value='".$row['idEquipo']."'>
                                                                <input type='hidden' name='user' id='user' value='".$user."'>
